...
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | Joystick select (B2) | PC0
| vioLED0       | vioSignalOut.0 | LED green       (LD6)| PC12
| vioLED1       | vioSignalOut.1 | LED green       (LD7)| PD5
| vioLED2       | vioSignalOut.2 | LED orange      (LD4)| PD9
| vioLED3       | vioSignalOut.3 | LED orange      (LD5)| PD8
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTC(12), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTD(5),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED2,    GPIO_PIN_ID_PORTD(9),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED3,    GPIO_PIN_ID_PORTD(8),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
...
//  signal,     pin,                   pull resistor,      active state
  { vioBUTTON0, GPIO_PIN_ID_PORTC(0),  ARM_GPIO_PULL_DOWN, VIO_ACTIVE_HIGH }
};
#endif
